            ...
            <div className='flex flex-col'>
                    ...
                    <button 
                        onClick={ () => setConfirmationModal({
                            text1: "Are You Sure ?",
                            text2: <div className='mt-[1rem]'>You will be logged out of your Account</div>,
                            btn1Text: <div className='ml-[1rem] text-yellow-5'>Logout</div>,
                            btn2Text:<div className='ml-[8rem] text-yellow-5'>Cancel</div>,
